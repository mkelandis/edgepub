...
import { getMicropub, getMicropubEntry, getMicropubMedia, getMicropubPhoto } from './get/get';
...
router
  ...
  .get('/index.html', (req, env) => {return index(req, env)})
	...
	.get('/micropub/media/:slug/:filename', (req, env) => {return getMicropubMedia(req, env)})
	.get('/micropub/photos/:slug/:filename', (req, env) => {return getMicropubPhoto(req, env)})
	.get('/micropub', (req, env) => {return getMicropub(req, env)})
	// .post('/micropub/media', (req, env) => {return postMicropubMedia(req, env)})
	.post('/micropub/media', (req, env) => {return post(req, env)})
